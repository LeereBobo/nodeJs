var openid; 
requestByGET("http://special.applinzi.com/CountMoney/php/get_openid.php",function(res){
	openid = res;
});
...
function show_ranking_div(){
	...
	/**/
	$url = "http://special.applinzi.com/CountMoney/php/get_ranking_list.php";
	...
	var countNumberTimer = setInterval(function(){
		if (beginCount) {
			if(countNumber > 0){
				...
				requestByGET("http://special.applinzi.com/CountMoney/php/update_score.php?openid="+openid+"&score="+number ,function(score){
